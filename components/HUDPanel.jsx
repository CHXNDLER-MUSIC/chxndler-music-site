                  ...
                  return (
                    <>
                      ...
                      {(() => {
                        ...
                        const isElementPlanet = ELEMENT_PLANETS.includes(active);
                        if (currentId && spotifyUrl && !isElementPlanet) {
                          return (
                            <a
                              href={spotifyUrl}
                              target="_blank"
                        ...
                        return (
                          <div className="spotify-btn-unavailable-hud" style={{ marginTop: 1 }} title={isElementPlanet ? 'Spotify not available for elemental planets' : (!currentId) ? 'Spotify not available on homepage' : `No Spotify link available for ${currentSong?.title || 'current track'}`}>
