    ...
    >
      <div className="max-w-[34rem] sm:max-w-[42rem] lg:max-w-[60rem]">
        ...
        <motion.button
          ...
          className="group relative mt-[2.25rem] sm:mt-[2.75rem] inline-flex items-center justify-center gap-[0.875rem] rounded-full px-[3.25rem] py-[1.375rem] text-[1.0625rem] sm:text-[1.1875rem] font-bold tracking-[0.08em] uppercase transition-colors duration-200 hover:bg-[#e0eb00] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-[0.35rem]"
          style={{ backgroundColor: "#F5FF3D", color: STUDIO_ON_PINK, outlineColor: STUDIO_ON_PINK }}
        >
