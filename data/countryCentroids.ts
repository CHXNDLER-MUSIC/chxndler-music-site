/**
 * Centroid coordinates (lat, lon) for countries by ISO 3166-1 alpha-2 code.
 * Used to place user-location dots on the flat world map SVG.
 */
export const countryCentroids: Record<string, { lat: number; lon: number }> = {
  ...
  HK: { lat: 22.40, lon: 114.11 },
  MO: { lat: 22.20, lon: 113.54 },
  PR: { lat: 18.22, lon: -66.59 },
  GL: { lat: 71.71, lon: -42.60 },
  PS: { lat: 31.95, lon: 35.23 },
  XK: { lat: 42.60, lon: 20.90 },
};
